...
## [1.5.0-dev](https://github.com/eddbbt/astarte/compare/v1.5.0-dev...v1.5.0-dev) (2026-08-19)


### ⚠ BREAKING CHANGES

* return Policy directly from from_policy_proto ([#168](https://github.com/eddbbt/astarte/issues/168))
...
* **adapters:** add `transformp` ([#2048](https://github.com/eddbbt/astarte/issues/2048)) ([46e4337](https://github.com/eddbbt/astarte/commit/46e433781ef1c2bc76f54088f4c43c149964b106))
...
* add keepalive option ([34d0302](https://github.com/eddbbt/astarte/commit/34d03020ba4c34b63649e9d6762da38f782c1580))
...
* add support for data encryption in interface mappings ([af1174a](https://github.com/eddbbt/astarte/commit/af1174a792f43637972e76b4a2c3e290a11a7c2d))
* **appengine:** Decrypt stored values ([#2029](https://github.com/eddbbt/astarte/issues/2029)) ([d0fa44e](https://github.com/eddbbt/astarte/commit/d0fa44e83758d81b42a5e64b4baba482eb7d3c49))
* **appengine:** Encrypt value before publishing ([75feb09](https://github.com/eddbbt/astarte/commit/75feb094dd87f9c80f646fff1a10e9eaf7687ed1))
...
* **dup:** Encrypt device shared secret ([#2104](https://github.com/eddbbt/astarte/issues/2104)) ([5047681](https://github.com/eddbbt/astarte/commit/5047681b9d530e88eff77ac9618bea5932ef98af))
...
* **housekeeping:** Create realm KEK during realm migrations ([1ae655d](https://github.com/eddbbt/astarte/commit/1ae655d043abec6c248107e736f40ca66521276e))
...
* **mapping:** Add required field ([#141](https://github.com/eddbbt/astarte/issues/141)) ([40c707a](https://github.com/eddbbt/astarte/commit/40c707afce475f2b49404ec49ee893f8a1698c5e))
...
* Store shared secret as session_key ([897a383](https://github.com/eddbbt/astarte/commit/897a383f79596e37a6ddf3dcb70520c89d97f2ef))
...
* allow rpc server horizontal scalability ([ab28f63](https://github.com/eddbbt/astarte/commit/ab28f634d551e6005440e75ab3a0edccaaa0a4c6))
* allow rpc server horizontal scalability ([0d0ce1f](https://github.com/eddbbt/astarte/commit/0d0ce1fb2e6725396a8cdd97cd424a5b1b3fff2a))
* **appengine:** Handle parameters on encrypted endpoints ([#2120](https://github.com/eddbbt/astarte/issues/2120)) ([029c630](https://github.com/eddbbt/astarte/commit/029c630f426141fc66ef8864cc9a11e5e43d01e9))
...
* avoid race condition with queue termination ([df38d63](https://github.com/eddbbt/astarte/commit/df38d632ae09ecbf9ae86232481dc3f3c5d59588))
* avoid race condition with queue termination ([19bbc24](https://github.com/eddbbt/astarte/commit/19bbc241aa8570c19616e48160561f928c901789))
...
* **dup:** enforce strict state transitions for errors and resets ([#2046](https://github.com/eddbbt/astarte/issues/2046)) ([236742c](https://github.com/eddbbt/astarte/commit/236742cebc39f98b16880c24175d1d6b6c7cbbc8))
...
* ensure RPC server reliability ([#150](https://github.com/eddbbt/astarte/issues/150)) ([9990d48](https://github.com/eddbbt/astarte/commit/9990d4806bf41a2f8f499f6f43d89a30449ad515))
...
* **housekeeping:** Fix realm creation ([#2018](https://github.com/eddbbt/astarte/issues/2018)) ([036172b](https://github.com/eddbbt/astarte/commit/036172bd9f1ec8b90b327e9b8127b4ecaf04a6ea))
...
* **mappings:** allow required key for object aggregated interface ([#142](https://github.com/eddbbt/astarte/issues/142)) ([a6efa2e](https://github.com/eddbbt/astarte/commit/a6efa2e87b7f121cc7656640cdff88c408e180f5))
...
* properly cleanup rpc supervisor ([1b66cc6](https://github.com/eddbbt/astarte/commit/1b66cc649db486316f9a4cca5e7d6ebf7e3988c3))
...
* reject interfaces with conflicting options in aggregate mappings (fw-port for release 1.3) ([42b92a5](https://github.com/eddbbt/astarte/commit/42b92a5c83aae0e5de23a4f611e87d703a5a24d5))
* Remove vulnerable cowlib dependency ([#2006](https://github.com/eddbbt/astarte/issues/2006)) ([30bfbf7](https://github.com/eddbbt/astarte/commit/30bfbf7fa36550d77024e3268ce6159c98be3a1a))
* resolve compile warnings-as-errors failures ([0d6c78a](https://github.com/eddbbt/astarte/commit/0d6c78a46656a67747883aadc0fbffac8470ec1d))
* resolve compile warnings-as-errors failures ([99733a3](https://github.com/eddbbt/astarte/commit/99733a3adeeaad0fb2afe999b9596ca744a325e4))
* resolve credo, dialyzer and deps.audit CI errors ([12d59ca](https://github.com/eddbbt/astarte/commit/12d59cae7f352758ccdfcba2bdab4d839e4eb5c5))
* resolve dialyzer and deps.audit CI errors ([38352db](https://github.com/eddbbt/astarte/commit/38352db64d125317f41badb98e1d420e4deabba1))
...
* trigger target decoding is now compliant to the typespec ([#133](https://github.com/eddbbt/astarte/issues/133)) ([43e96a2](https://github.com/eddbbt/astarte/commit/43e96a2bef68374647c10900c412a5c1cc2c9a83))
...
* **generators:** nuke to_changes + use adapters ([85c05c6](https://github.com/eddbbt/astarte/commit/85c05c67ccbf971c90c6c73a5f35facdb27cdf6f))
...
* return Policy directly from from_policy_proto ([#168](https://github.com/eddbbt/astarte/issues/168)) ([ceae205](https://github.com/eddbbt/astarte/commit/ceae2056ee37ed0b9413f74470f5e416db4f0cdf))


### Continuous Integration

* add release-please for automated versioning and changelog ([19f3d5a](https://github.com/eddbbt/astarte/commit/19f3d5a3c310fa5c3f72fddb416f1b7dcf5f0716))
