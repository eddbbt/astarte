...
defmodule Astarte.Events.Config do
  ...
  app_env(:amqp_consumer_host, :astarte_events, :amqp_consumer_host,
    os_env: "ASTARTE_EVENTS_AMQP_CONSUMER_HOST",
    type: :binary,
    default: "localhost"
  )

  @envdoc "The username for the AMQP consumer connection."
  app_env(:amqp_consumer_username, :astarte_events, :amqp_consumer_username,
    os_env: "ASTARTE_EVENTS_AMQP_CONSUMER_USERNAME",
    type: :binary,
    default: "guest"
  )

  @envdoc "The password for the AMQP consumer connection."
  app_env(:amqp_consumer_password, :astarte_events, :amqp_consumer_password,
    os_env: "ASTARTE_EVENTS_AMQP_CONSUMER_PASSWORD",
    type: :binary,
    default: "guest"
  )
  ...
  app_env(
    ...
    :astarte_events,
    :amqp_consumer_virtual_host,
    os_env: "ASTARTE_EVENTS_AMQP_CONSUMER_VIRTUAL_HOST",
    type: :binary,
    default: "/"
  )

  @envdoc "The port for the AMQP consumer connection."
  app_env(:amqp_consumer_port, :astarte_events, :amqp_consumer_port,
    os_env: "ASTARTE_EVENTS_AMQP_CONSUMER_PORT",
    type: :integer,
    default: 5672
  )

  @envdoc "Enable SSL for the AMQP consumer connection. If not specified, SSL is disabled."
  app_env(:amqp_consumer_ssl_enabled, :astarte_events, :amqp_consumer_ssl_enabled,
    os_env: "ASTARTE_EVENTS_AMQP_CONSUMER_SSL_ENABLED",
    type: :boolean,
    default: false
  )
  ...
  """
  app_env(:amqp_consumer_ssl_ca_file, :astarte_events, :amqp_consumer_ssl_ca_file,
    os_env: "ASTARTE_EVENTS_AMQP_CONSUMER_SSL_CA_FILE",
    type: :binary
  )
  ...
  app_env(
    ...
    :astarte_events,
    :amqp_consumer_ssl_disable_sni,
    os_env: "ASTARTE_EVENTS_AMQP_CONSUMER_SSL_DISABLE_SNI",
    type: :boolean,
    default: false
  )
  ...
  app_env(
    ...
    :astarte_events,
    :amqp_consumer_ssl_custom_sni,
    os_env: "ASTARTE_EVENTS_AMQP_CONSUMER_SSL_CUSTOM_SNI",
    type: :binary
  )
  ...
  app_env :amqp_consumer_connection_number,
          ...
          os_env: "ASTARTE_EVENTS_AMQP_CONSUMER_CONNECTION_NUMBER",
          type: :integer,
          default: 10
