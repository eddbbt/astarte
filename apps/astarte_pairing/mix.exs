...
defmodule Astarte.Pairing.Mixfile do
  ...
  defp astarte_required_modules(_) do
    [
      {:astarte_core,
       github: "astarte-platform/astarte_core", tag: "v1.7.0-test-release", override: true},
